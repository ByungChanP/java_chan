...
public class StringMethodTest {
    public static void main(String[] args) {
        ...
        // 10. str에 "java" 문자열이 나오는 인덱스를 출력하시오(6)
        // 단, 대소문자는 구분하지 않습니다.
        System.out.println(str.toLowerCase().indexOf("java".toLowerCase())); //return 타입이 String

        // 11. trim():  앞뒤의 공백을 제거 //로그인 메서드 만들깨 써먹기 좋음
        String str3 = "   Hello Java Wrold   ";
