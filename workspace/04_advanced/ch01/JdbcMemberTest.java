...
//        selectAllMembers();
//        try{
//            insertMember("haru"+ (int)(Math.random() * 1000) + "@gmail.com", "1234", "뉴하루", "010-4567-8888",2 );
//        } catch (IllegalArgumentException e) {
//            System.out.println(e.getMessage());
//            insertMember("haru"+ (int)(Math.random() * 1000) + "@gmail.com", "1234", "뉴하루", "010-4567-8888".replace("-",""),2 );
//        }
//
//        updateMember(3, "pwd678", "박지성", "01077774444");
//        deleteMember(1);
//        selectAllMembers();
    }
    ...
    public static void login(String email, String password) throws LoginfailException {
        ...
        if(email == null || email.isBlank() || password == null || password.isBlank()){
            throw new LoginfailException("이메일과 패스워드를 확인하세요");
        }
    ...
    public static void insertMember(String email, String password, String name, String phone,
                                    int recommenderId) throws IllegalArgumentException{

        if(phone.length() > 12){
            throw new IllegalArgumentException("phone은 12자 이내여야합니다.");
        }
